    ...
    drawing() {
      ...
      treeChart.prototype.graphTree = function (config) {
        ...
        function update(source, originalData, g) {
          ...
          //   d3.select(this).style("stroke", "#006eff");
          // });
          ...
          function nodeHover(d, i) {
            if (d.name != "origin") {
              console.log(d, i, "hover");
              if (d.parent.direction == "downward") {
                console.log(d3.selectAll(".downwardLink")[0]);
                d3.selectAll(".downwardLink")
                  .select(`#mypath${i}`)
                  .style("stroke", "red");
                ...
                links.forEach((item, index) => {
                  if (
                    ...
                    item.style["stroke-dasharray"] = '6,2';
                    item.style["stroke-dashoffset"] = 2;
                    item.style["animation"] = "dash 0.5s infinite";
                  }
                });
              } else {
                // console.log(d, i);
                // d3.selectAll(".upwardLink")
                //   .select(`#mypath${i}`)
                //   .style("stroke", "red");
              }
            }
          ...
          function nodeOut(d, i) {
            // if (d.name != "origin") {
            //   console.log(d, i, "out");
            //   // d3.select(`#mypath${i}`).style("stroke", "006eff");
            //   if (d.parent.direction == "downward") {
            //     console.log(
            //       d3.select(`#mypath${i}`),'ddddddddddddddddddddddd'
            //     );
            //     d3.selectAll(".downwardLink")
            //       .select(`#mypath${i}`)
            //       .style("stroke", "006eff");
            //   } else {
            //     console.log(
            //       d3.selectAll(".upwardLink").select(`#mypath${i}`),'uuuuuuuuuuuuuuuuuuuuu'
            //     );
            //     // console.log(d, i);
            //     d3.selectAll(".upwardLink")
            //       .select(`#mypath${i}`)
          ...
          function click(d) {
            console.log(d, "bbbbbbbbbbbbbbbbb");
            if (forUpward) {
            } else {
              console.log(d._children, "sssssssssssssssss");
              if (d._children != null) {
                console.log("对外投资--ok");
              } else {
                console.log("对外投资--no");
            ...
            console.log(d, "cccccccccccccccc");
            if (d.children) {
              d._children = [
                {
                  name: "公司或股东名字",
